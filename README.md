...
Zdjęcie można dodać z aparatu albo wybrać istniejący plik z galerii. Przed kalibracją można obrócić je przyciskami. W kalibracji nieruchomy celownik pozostaje na środku ekranu: najpierw przesuń i powiększ zdjęcie pod celownikiem, zablokuj punkt, a następnie ustaw pod nim to samo miejsce na OSM. Powtórz proces dla minimum czterech punktów rozłożonych po mapie i wybierz „Zakończ kalibrację”. Jednym palcem przesuwa się aktywną warstwę, a dwoma zmienia jej skalę; na etapie zdjęcia gest dwoma palcami pozwala też je obrócić.
